...
The input grammar description has its own grammar which is described in [peg2rb.peg](#peg2rb.peg) (in terms of the input grammar itself). You may also see samples of the grammar description in [samples](#samples).
