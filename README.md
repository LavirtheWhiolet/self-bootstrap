...
See <a href="peg2rb - User Guide.html">peg2rb - User Guide.html</a> for details on the input grammar description and the output parser. You may also see samples of the grammar descriptions in [samples](#samples).
