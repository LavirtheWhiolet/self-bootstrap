...
Input grammar is described in [peg2rb.peg](#peg2rb.peg) in terms of [peg2rb.rb](#peg2rb.rb)'s input grammar itself. You may also see samples of the input grammar in [samples](#samples).
