...
The input grammar description has its own grammar which is described in [peg2rb.peg](#peg2rb.peg) (in terms of the extended [PEG](http://en.wikipedia.org/wiki/Parsing_expression_grammar) itself). You may also see samples of the description in [samples](#samples).
