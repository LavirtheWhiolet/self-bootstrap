...
(begin
      ...
      yy_var54
    end and begin; yy_var55 = @yy_input.pos; yy_string("...") or (@yy_input.pos = yy_var55; yy_string("..")) or (@yy_input.pos = yy_var55; yy_string("\u{2026}")) or (@yy_input.pos = yy_var55; yy_string("\u{2025}")); end and begin
