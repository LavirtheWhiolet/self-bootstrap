...
def yy_nonterm8p 
val = :yy_nil 
(begin; yy_var8o = @yy_input.pos; yy_string("<-") or (@yy_input.pos = yy_var8o; yy_string("=")) or (@yy_input.pos = yy_var8o; yy_string("\u{2190}")); end and yy_nontermev()) and yy_to_pcv(val) 
end 
def yy_nonterm8r 
val = :yy_nil 
...
while true
      ...
      if not begin; yy_varet = @yy_input.pos; yy_nontermf5() or (@yy_input.pos = yy_varet; yy_nontermf3()); end then
...
def yy_nontermf5 
val = :yy_nil 
begin; yy_varf4 = @yy_input.pos; yy_char_range("\t", "\r") or (@yy_input.pos = yy_varf4; yy_string(" ")) or (@yy_input.pos = yy_varf4; yy_string("\u{85}")) or (@yy_input.pos = yy_varf4; yy_string("\u{a0}")) or (@yy_input.pos = yy_varf4; yy_string("\u{1680}")) or (@yy_input.pos = yy_varf4; yy_string("\u{180e}")) or (@yy_input.pos = yy_varf4; yy_char_range("\u{2000}", "\u{200a}")) or (@yy_input.pos = yy_varf4; yy_string("\u{2028}")) or (@yy_input.pos = yy_varf4; yy_string("\u{2029}")) or (@yy_input.pos = yy_varf4; yy_string("\u{202f}")) or (@yy_input.pos = yy_varf4; yy_string("\u{205f}")) or (@yy_input.pos = yy_varf4; yy_string("\u{3000}")); end and yy_to_pcv(val) 
end 
def yy_nontermf7 
val = :yy_nil 
begin; yy_varf6 = @yy_input.pos; (yy_string("\r") and yy_string("\n")) or (@yy_input.pos = yy_varf6; yy_string("\r")) or (@yy_input.pos = yy_varf6; yy_string("\n")) or (@yy_input.pos = yy_varf6; yy_string("\u{85}")) or (@yy_input.pos = yy_varf6; yy_string("\v")) or (@yy_input.pos = yy_varf6; yy_string("\f")) or (@yy_input.pos = yy_varf6; yy_string("\u{2028}")) or (@yy_input.pos = yy_varf6; yy_string("\u{2029}")); end and yy_to_pcv(val) 
end 
